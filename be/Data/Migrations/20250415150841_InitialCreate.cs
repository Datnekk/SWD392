    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a1b2c3d4-e5f6-7890-abcd-ef1234567890"), null, "Student", "STUDENT" },
                    { new Guid("b2c3d4e5-f678-9012-bcde-f12345678901"), null, "Proctors ", "PROCTORS" }
                });
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_Sessions_CurrentSessionId",
                table: "AspNetUsers",
                column: "CurrentSessionId",
